...
public class LocalGoods extends JFrame {
	...
	JButton hotjb = new JButton(new ImageIcon("C:/LocalGoods/img/icons/hotlink.jpg"));
	...
	public LocalGoods() {
		...
		//Chickens
	    com.esri.mo2.map.dpy.Layer lchicken = ((Legend)list.get(2)).getLayer();
		...
		rmschicken.setSizeX(16);
		rmschicken.setSizeY(16);
		rmschicken.setImageString("C:/LocalGoods/img/icons/chicken.png");	
		...
		//Cows
	    com.esri.mo2.map.dpy.Layer lcow = ((Legend)list.get(0)).getLayer();
		...
		rmscow.setSizeX(16);
		rmscow.setSizeY(16);
		rmscow.setImageString("C:/LocalGoods/img/icons/cow.png");	
		...
		//Produce
	    com.esri.mo2.map.dpy.Layer lproduce = ((Legend)list.get(1)).getLayer();
		...
		rmsproduce.setSizeX(16);
		rmsproduce.setSizeY(16);
		rmsproduce.setImageString("C:/LocalGoods/img/icons/produce.png");	
	    ...
	    com.esri.mo2.map.dpy.Layer lay1 = ((Legend)list.get(4)).getLayer();
		...
		rms.setSizeX(16);
		rms.setSizeY(16);
		rms.setImageString("C:/LocalGoods/img/icons/farmhouse.png");	
	    BaseSimpleRenderer bsr1 = (BaseSimpleRenderer)flayer1.getRenderer();
		bsr1.setSymbol(rms) ;
		
		//Farmer's Markets
	    com.esri.mo2.map.dpy.Layer lay0 = ((Legend)list.get(3)).getLayer();
		...
		rms0.setSizeX(16);
		rms0.setSizeY(16);
		rms0.setImageString("C:/LocalGoods/img/icons/farmersmarkets.png");	
	    BaseSimpleRenderer bsr0 = (BaseSimpleRenderer)flayer0.getRenderer();
		bsr0.setSymbol(rms0) ;		
		

	    //SD County
	    com.esri.mo2.map.dpy.Layer lay2 = ((Legend)list.get(5)).getLayer();
		...
		//California
		com.esri.mo2.map.dpy.Layer lay3 = ((Legend)list.get(6)).getLayer();
				...
				if (source == cancel) {
					...
					try {
						...
						if (LocalGoods.stb.getSelectedLayers() != null) {
							LocalGoods.pitem.setEnabled(true);
						}
					} catch(IOException e){}
				}
			}
